...
public:
	...
	inline int getCULTURE_CITY_LOST_CONQUEST()
	{
		return m_iCULTURE_CITY_LOST_CONQUEST;
	}
	inline int getCULTURE_CITY_GAIN_CONQUEST()
	{
		return m_iCULTURE_CITY_GAIN_CONQUEST;
	}
	inline int getCULTURE_PLOT_LOST_CONQUEST()
	{
		return m_iCULTURE_PLOT_LOST_CONQUEST;
	}
	inline int getCULTURE_PLOT_GAIN_CONQUEST()
	{
		return m_iCULTURE_PLOT_GAIN_CONQUEST;
	}
	...
	inline int getCULTURE_TRADITION_OPENER_CONVERTION_RATE()
	{
		return m_iCULTURE_TRADITION_OPENER_CONVERTION_RATE;
	}
	inline int getCULTURE_TRADITION_FINISHER_CONVERTION_RATE()
	{
		return m_iCULTURE_TRADITION_FINISHER_CONVERTION_RATE;
	}
	inline int getCULTURE_SOCIALIST_REALISM_CONVERTION_RATE()
	{
		return m_iCULTURE_SOCIALIST_REALISM_CONVERTION_RATE;
	}
	inline int getCULTURE_MEDIA_CULTURE_CONVERTION_RATE()
	{
		return m_iCULTURE_MEDIA_CULTURE_CONVERTION_RATE;
	}
	inline int getCULTURE_NATIONALISM_CONVERTION_RATE()
	{
		return m_iCULTURE_NATIONALISM_CONVERTION_RATE;
	}
	inline int getCULTURE_LIBRARY_CONVERTION_RATE()
	{
		return m_iCULTURE_LIBRARY_CONVERTION_RATE;
	}
	inline int getCULTURE_UNIVERSITY_CONVERTION_RATE()
	{
		return m_iCULTURE_UNIVERSITY_CONVERTION_RATE;
	}
	inline int getCULTURE_PUBLIC_SCHOOL_CONVERTION_RATE()
	{
		return m_iCULTURE_PUBLIC_SCHOOL_CONVERTION_RATE;
	}
	inline int getCULTURE_IMPROVEMENT_CONVERTION_RATE()
	{
		return m_iCULTURE_IMPROVEMENT_CONVERTION_RATE;
	}
	inline int getCULTURE_UNIT_CONVERTION_RATE()
	{
		return m_iCULTURE_UNIT_CONVERTION_RATE;
	}
	// RED >>>>>
...
protected:
	...
	************************************************************************************************************************/
	...
	int m_iCULTURE_CITY_LOST_CONQUEST;
	int m_iCULTURE_CITY_GAIN_CONQUEST;
	int m_iCULTURE_PLOT_LOST_CONQUEST;
	int m_iCULTURE_PLOT_GAIN_CONQUEST;
	...
	int m_iCULTURE_TRADITION_OPENER_CONVERTION_RATE;
	int m_iCULTURE_TRADITION_FINISHER_CONVERTION_RATE;
	int m_iCULTURE_SOCIALIST_REALISM_CONVERTION_RATE;
	int m_iCULTURE_MEDIA_CULTURE_CONVERTION_RATE;
	int m_iCULTURE_NATIONALISM_CONVERTION_RATE;
	int m_iCULTURE_LIBRARY_CONVERTION_RATE;
	int m_iCULTURE_UNIVERSITY_CONVERTION_RATE;
	int m_iCULTURE_PUBLIC_SCHOOL_CONVERTION_RATE;
	int m_iCULTURE_IMPROVEMENT_CONVERTION_RATE;
	int m_iCULTURE_UNIT_CONVERTION_RATE;		
	// RED >>>>>
