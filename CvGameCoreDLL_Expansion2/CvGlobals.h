...
public:
	...
	inline int getAI_HOMELAND_MOVE_PRIORITY_DIPLOMAT_EMBASSY()
	{
		return m_iAI_HOMELAND_MOVE_PRIORITY_DIPLOMAT_EMBASSY;
	}
...
//Faith to Votes
	inline int getFAITH_TO_VOTES()
	{
	return m_iFAITH_TO_VOTES;
	}
#endif
...
#if defined(MOD_DIPLOMACY_CITYSTATES)
	int m_iAI_HOMELAND_MOVE_PRIORITY_DIPLOMAT_EMBASSY;
