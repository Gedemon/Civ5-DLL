...
public:
	...
	// Cultural Diffusion
	inline int getCULTURE_DIFFUSION_ENABLED()
	{
		return m_iCULTURE_DIFFUSION_ENABLED;
	}
	inline int getCULTURE_CITY_CAPED_FACTOR()
	{
		return m_iCULTURE_CITY_CAPED_FACTOR;
	}	
	inline int getCULTURE_DECAY_RATE()
	{
		return m_iCULTURE_DECAY_RATE;
	}
	inline int getCULTURE_ALLOW_TILE_ACQUISITION()
	{
		return m_iCULTURE_ALLOW_TILE_ACQUISITION;
	}
	inline int getCULTURE_ALLOW_TILE_FLIPPING()
	{
		return m_iCULTURE_ALLOW_TILE_FLIPPING;
	}
	inline int getCULTURE_USE_POLICIES()
	{
		return m_iCULTURE_USE_POLICIES;
	}
	inline int getCULTURE_MAX_LINES_UI()
	{
		return m_iCULTURE_MAX_LINES_UI;
	}
	inline int getCULTURE_CITY_BASE_PRODUCTION()
	{
		return m_iCULTURE_CITY_BASE_PRODUCTION;
	}
	inline int getCULTURE_CITY_FACTOR()
	{
		return m_iCULTURE_CITY_FACTOR;
	}
	inline int getCULTURE_CITY_RATIO()
	{
		return m_iCULTURE_CITY_RATIO;
	}
	inline int getCULTURE_OUTPUT_USE_LOG()
	{
		return m_iCULTURE_OUTPUT_USE_LOG;
	}
	inline int getCULTURE_CITY_CONVERSION_RATE()
	{
		return m_iCULTURE_CITY_CONVERSION_RATE;
	}
	inline int getCULTURE_LOST_CITY_CONQUEST()
	{
		return m_iCULTURE_LOST_CITY_CONQUEST;
	}
	inline int getCULTURE_GAIN_CITY_CONQUEST()
	{
		return m_iCULTURE_GAIN_CITY_CONQUEST;
	}
	inline int getCULTURE_LOST_PLOT_CONQUEST()
	{
		return m_iCULTURE_LOST_PLOT_CONQUEST;
	}
	inline int getCULTURE_GAIN_PLOT_CONQUEST()
	{
		return m_iCULTURE_GAIN_PLOT_CONQUEST;
	}
	inline int getCULTURE_MINIMUM_FOR_ACQUISITION()
	{
		return m_iCULTURE_MINIMUM_FOR_ACQUISITION;
	}
	inline int getCULTURE_FLIPPING_RATIO()
	{
		return m_iCULTURE_FLIPPING_RATIO;
	}
	inline int getCULTURE_FLIPPING_MAX_DISTANCE()
	{
		return m_iCULTURE_FLIPPING_MAX_DISTANCE;
	}
	inline int getCULTURE_FLIPPING_ONLY_ADJACENT()
	{
		return m_iCULTURE_FLIPPING_ONLY_ADJACENT;
	}
	inline int getCULTURE_NO_FORTIFICATION_FLIPPING()
	{
		return m_iCULTURE_NO_FORTIFICATION_FLIPPING;
	}
	inline int getCULTURE_MINIMAL_ON_OWNED_PLOT()
	{
		return m_iCULTURE_MINIMAL_ON_OWNED_PLOT;
	}
	inline int getCULTURE_DIFFUSION_THRESHOLD()
	{
		return m_iCULTURE_DIFFUSION_THRESHOLD;
	}
	inline int getCULTURE_CROSS_MOUNTAIN_THRESHOLD()
	{
		return m_iCULTURE_CROSS_MOUNTAIN_THRESHOLD;
	}
	inline int getCULTURE_CROSS_MARSH_THRESHOLD()
	{
		return m_iCULTURE_CROSS_MARSH_THRESHOLD;
	}
	inline int getCULTURE_CROSS_JUNGLE_THRESHOLD()
	{
		return m_iCULTURE_CROSS_JUNGLE_THRESHOLD;
	}
	inline int getCULTURE_CROSS_SNOW_THRESHOLD()
	{
		return m_iCULTURE_CROSS_SNOW_THRESHOLD;
	}
	inline int getCULTURE_CROSS_DESERT_THRESHOLD()
	{
		return m_iCULTURE_CROSS_DESERT_THRESHOLD;
	}
	inline int getCULTURE_CROSS_TUNDRA_THRESHOLD()
	{
		return m_iCULTURE_CROSS_TUNDRA_THRESHOLD;
	}
	inline int getCULTURE_CROSS_RIVER_THRESHOLD()
	{
		return m_iCULTURE_CROSS_RIVER_THRESHOLD;
	}
	inline int getCULTURE_CROSS_HILLS_THRESHOLD()
	{
		return m_iCULTURE_CROSS_HILLS_THRESHOLD;
	}
	inline int getCULTURE_CROSS_FOREST_THRESHOLD()
	{
		return m_iCULTURE_CROSS_FOREST_THRESHOLD;
	}
	inline int getCULTURE_DIFFUSION_RATE()
	{
		return m_iCULTURE_DIFFUSION_RATE;
	}
	inline int getCULTURE_ABSOLUTE_MAX_PERCENT()
	{
		return m_iCULTURE_ABSOLUTE_MAX_PERCENT;
	}
	inline int getCULTURE_NORMAL_MAX_PERCENT()
	{
		return m_iCULTURE_NORMAL_MAX_PERCENT;
	}
	inline int getCULTURE_FOLLOW_RIVER_MAX()
	{
		return m_iCULTURE_FOLLOW_RIVER_MAX;
	}
	inline int getCULTURE_FOLLOW_ROAD_MAX()
	{
		return m_iCULTURE_FOLLOW_ROAD_MAX;
	}
	inline int getCULTURE_CROSS_FOREST_MAX()
	{
		return m_iCULTURE_CROSS_FOREST_MAX;
	}
	inline int getCULTURE_CROSS_HILLS_MAX()
	{
		return m_iCULTURE_CROSS_HILLS_MAX;
	}
	inline int getCULTURE_CROSS_TUNDRA_MAX()
	{
		return m_iCULTURE_CROSS_TUNDRA_MAX;
	}
	inline int getCULTURE_CROSS_RIVER_MAX()
	{
		return m_iCULTURE_CROSS_RIVER_MAX;
	}
	inline int getCULTURE_CROSS_DESERT_MAX()
	{
		return m_iCULTURE_CROSS_DESERT_MAX;
	}
	inline int getCULTURE_CROSS_SNOW_MAX()
	{
		return m_iCULTURE_CROSS_SNOW_MAX;
	}
	inline int getCULTURE_CROSS_JUNGLE_MAX()
	{
		return m_iCULTURE_CROSS_JUNGLE_MAX;
	}
	inline int getCULTURE_CROSS_MARSH_MAX()
	{
		return m_iCULTURE_CROSS_MARSH_MAX;
	}
	inline int getCULTURE_CROSS_MOUNTAIN_MAX()
	{
		return m_iCULTURE_CROSS_MOUNTAIN_MAX;
	}
	inline int getCULTURE_CROSS_FOREST_PENALTY()
	{
		return m_iCULTURE_CROSS_FOREST_PENALTY;
	}
	inline int getCULTURE_CROSS_HILLS_PENALTY()
	{
		return m_iCULTURE_CROSS_HILLS_PENALTY;
	}
	inline int getCULTURE_CROSS_TUNDRA_PENALTY()
	{
		return m_iCULTURE_CROSS_TUNDRA_PENALTY;
	}
	inline int getCULTURE_CROSS_RIVER_PENALTY()
	{
		return m_iCULTURE_CROSS_RIVER_PENALTY;
	}
	inline int getCULTURE_CROSS_DESERT_PENALTY()
	{
		return m_iCULTURE_CROSS_DESERT_PENALTY;
	}
	inline int getCULTURE_CROSS_SNOW_PENALTY()
	{
		return m_iCULTURE_CROSS_SNOW_PENALTY;
	}
	inline int getCULTURE_CROSS_JUNGLE_PENALTY()
	{
		return m_iCULTURE_CROSS_JUNGLE_PENALTY;
	}
	inline int getCULTURE_CROSS_MARSH_PENALTY()
	{
		return m_iCULTURE_CROSS_MARSH_PENALTY;
	}
	inline int getCULTURE_CROSS_MOUNTAIN_PENALTY()
	{
		return m_iCULTURE_CROSS_MOUNTAIN_PENALTY;
	}
	inline int getCULTURE_FOLLOW_RIVER_BONUS()
	{
		return m_iCULTURE_FOLLOW_RIVER_BONUS;
	}
	inline int getCULTURE_FOLLOW_ROAD_BONUS()
	{
		return m_iCULTURE_FOLLOW_ROAD_BONUS;
	}
	inline int getCULTURE_CONQUEST_ENABLED()
	{
		return m_iCULTURE_CONQUEST_ENABLED;
	}
	inline int getCULTURE_MINIMAL_FOR_CONQUEST()
	{
		return m_iCULTURE_MINIMAL_FOR_CONQUEST;
	}
	inline int getCULTURE_CONQUEST_EVEN_LOWER()
	{
		return m_iCULTURE_CONQUEST_EVEN_LOWER;
	}
	inline int getCULTURE_CONQUEST_EVEN_NONE()
	{
		return m_iCULTURE_CONQUEST_EVEN_NONE;
	}
	inline int getCULTURE_LOCKED_TURN_ON_CONQUEST()
	{
		return m_iCULTURE_LOCKED_TURN_ON_CONQUEST;
	}
	inline int getCULTURE_CONQUEST_ONLY_ADJACENT()
	{
		return m_iCULTURE_CONQUEST_ONLY_ADJACENT;
	}
	inline int getCULTURE_LOCK_FLIPPING_ON_WAR()
	{
		return m_iCULTURE_LOCK_FLIPPING_ON_WAR;
	}
	inline int getCULTURE_TRADITION_OPENER_CONVERSION_RATE()
	{
		return m_iCULTURE_TRADITION_OPENER_CONVERSION_RATE;
	}
	inline int getCULTURE_TRADITION_FINISHER_CONVERSION_RATE()
	{
		return m_iCULTURE_TRADITION_FINISHER_CONVERSION_RATE;
	}
	inline int getCULTURE_SOCIALIST_REALISM_CONVERSION_RATE()
	{
		return m_iCULTURE_SOCIALIST_REALISM_CONVERSION_RATE;
	}
	inline int getCULTURE_MEDIA_CULTURE_CONVERSION_RATE()
	{
		return m_iCULTURE_MEDIA_CULTURE_CONVERSION_RATE;
	}
	inline int getCULTURE_NATIONALISM_CONVERSION_RATE()
	{
		return m_iCULTURE_NATIONALISM_CONVERSION_RATE;
	}
	inline int getCULTURE_LIBRARY_CONVERSION_RATE()
	{
		return m_iCULTURE_LIBRARY_CONVERSION_RATE;
	}
	inline int getCULTURE_UNIVERSITY_CONVERSION_RATE()
	{
		return m_iCULTURE_UNIVERSITY_CONVERSION_RATE;
	}
	inline int getCULTURE_PUBLIC_SCHOOL_CONVERSION_RATE()
	{
		return m_iCULTURE_PUBLIC_SCHOOL_CONVERSION_RATE;
	}
	inline int getCULTURE_IMPROVEMENT_CONVERSION_RATE()
	{
		return m_iCULTURE_IMPROVEMENT_CONVERSION_RATE;
	}
	inline int getCULTURE_UNIT_CONVERSION_RATE()
	{
		return m_iCULTURE_UNIT_CONVERSION_RATE;
	}

	GD_INT_DEF(CULTURE_DIFFUSION_VARIATION_BY_ERA)
	GD_INT_DEF(CULTURE_LIBERATE_PLOT_ENABLED)
	GD_INT_DEF(CULTURE_LIBERATE_PLOT_CS_BONUS)
...
protected:
	...
	************************************************************************************************************************/
	...
	int m_iCULTURE_DIFFUSION_ENABLED;
	int m_iCULTURE_CITY_CAPED_FACTOR;
	int m_iCULTURE_DECAY_RATE;
	int m_iCULTURE_ALLOW_TILE_ACQUISITION;
	int m_iCULTURE_ALLOW_TILE_FLIPPING;
	int m_iCULTURE_USE_POLICIES;
	int m_iCULTURE_MAX_LINES_UI;
	int m_iCULTURE_CITY_BASE_PRODUCTION;
	int m_iCULTURE_CITY_FACTOR;
	int m_iCULTURE_CITY_RATIO;
	int m_iCULTURE_OUTPUT_USE_LOG;
	int m_iCULTURE_CITY_CONVERSION_RATE;
	int m_iCULTURE_LOST_CITY_CONQUEST;
	int m_iCULTURE_GAIN_CITY_CONQUEST;
	int m_iCULTURE_LOST_PLOT_CONQUEST;
	int m_iCULTURE_GAIN_PLOT_CONQUEST;
	int m_iCULTURE_MINIMUM_FOR_ACQUISITION;
	int m_iCULTURE_FLIPPING_RATIO;
	int m_iCULTURE_FLIPPING_MAX_DISTANCE;
	int m_iCULTURE_FLIPPING_ONLY_ADJACENT;
	int m_iCULTURE_NO_FORTIFICATION_FLIPPING;
	int m_iCULTURE_MINIMAL_ON_OWNED_PLOT;
	int m_iCULTURE_DIFFUSION_THRESHOLD;
	int m_iCULTURE_CROSS_MOUNTAIN_THRESHOLD;
	int m_iCULTURE_CROSS_MARSH_THRESHOLD;
	int m_iCULTURE_CROSS_JUNGLE_THRESHOLD;
	int m_iCULTURE_CROSS_SNOW_THRESHOLD;
	int m_iCULTURE_CROSS_DESERT_THRESHOLD;
	int m_iCULTURE_CROSS_TUNDRA_THRESHOLD;
	int m_iCULTURE_CROSS_RIVER_THRESHOLD;
	int m_iCULTURE_CROSS_HILLS_THRESHOLD;
	int m_iCULTURE_CROSS_FOREST_THRESHOLD;
	int m_iCULTURE_DIFFUSION_RATE;
	int m_iCULTURE_ABSOLUTE_MAX_PERCENT;
	int m_iCULTURE_NORMAL_MAX_PERCENT;
	int m_iCULTURE_FOLLOW_RIVER_MAX;
	int m_iCULTURE_FOLLOW_ROAD_MAX;
	int m_iCULTURE_CROSS_FOREST_MAX;
	int m_iCULTURE_CROSS_HILLS_MAX;
	int m_iCULTURE_CROSS_TUNDRA_MAX;
	int m_iCULTURE_CROSS_RIVER_MAX;
	int m_iCULTURE_CROSS_DESERT_MAX;
	int m_iCULTURE_CROSS_SNOW_MAX;
	int m_iCULTURE_CROSS_JUNGLE_MAX;
	int m_iCULTURE_CROSS_MARSH_MAX;
	int m_iCULTURE_CROSS_MOUNTAIN_MAX;
	int m_iCULTURE_CROSS_FOREST_PENALTY;
	int m_iCULTURE_CROSS_HILLS_PENALTY;
	int m_iCULTURE_CROSS_TUNDRA_PENALTY;
	int m_iCULTURE_CROSS_RIVER_PENALTY;
	int m_iCULTURE_CROSS_DESERT_PENALTY;
	int m_iCULTURE_CROSS_SNOW_PENALTY;
	int m_iCULTURE_CROSS_JUNGLE_PENALTY;
	int m_iCULTURE_CROSS_MARSH_PENALTY;
	int m_iCULTURE_CROSS_MOUNTAIN_PENALTY;
	int m_iCULTURE_FOLLOW_RIVER_BONUS;
	int m_iCULTURE_FOLLOW_ROAD_BONUS;
	int m_iCULTURE_CONQUEST_ENABLED;
	int m_iCULTURE_MINIMAL_FOR_CONQUEST;
	int m_iCULTURE_CONQUEST_EVEN_LOWER;
	int m_iCULTURE_CONQUEST_EVEN_NONE;
	int m_iCULTURE_LOCKED_TURN_ON_CONQUEST;
	int m_iCULTURE_CONQUEST_ONLY_ADJACENT;
	int m_iCULTURE_LOCK_FLIPPING_ON_WAR;
	int m_iCULTURE_TRADITION_OPENER_CONVERSION_RATE;
	int m_iCULTURE_TRADITION_FINISHER_CONVERSION_RATE;
	int m_iCULTURE_SOCIALIST_REALISM_CONVERSION_RATE;
	int m_iCULTURE_MEDIA_CULTURE_CONVERSION_RATE;
	int m_iCULTURE_NATIONALISM_CONVERSION_RATE;
	int m_iCULTURE_LIBRARY_CONVERSION_RATE;
	int m_iCULTURE_UNIVERSITY_CONVERSION_RATE;
	int m_iCULTURE_PUBLIC_SCHOOL_CONVERSION_RATE;
	int m_iCULTURE_IMPROVEMENT_CONVERSION_RATE;
	int m_iCULTURE_UNIT_CONVERSION_RATE;
	
	GD_INT_DECL(CULTURE_DIFFUSION_VARIATION_BY_ERA)
	GD_INT_DECL(CULTURE_LIBERATE_PLOT_ENABLED)
	GD_INT_DECL(CULTURE_LIBERATE_PLOT_CS_BONUS)
	// RED >>>>>
