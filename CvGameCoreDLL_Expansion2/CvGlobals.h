...
public:
	...
	inline int getCULTURE_FLIPPING_RATIO_FEEBLE()
	{
		return m_iCULTURE_FLIPPING_RATIO_FEEBLE;
	}
	...
	inline int getCULTURE_MAX_ADJACENT_PERCENT()
	{
		return m_iCULTURE_MAX_ADJACENT_PERCENT;
	}
	inline int getCULTURE_NORMAL_MAX()
	{
		return m_iCULTURE_NORMAL_MAX;
	}
...
protected:
	...
	************************************************************************************************************************/
	...
	int m_iCULTURE_FLIPPING_RATIO_FEEBLE;
	...
	int m_iCULTURE_MAX_ADJACENT_PERCENT;
	int m_iCULTURE_NORMAL_MAX;
