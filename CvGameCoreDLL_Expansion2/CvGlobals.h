...
public:
	...
	inline int getAI_CONFIG_MILITARY_MELEE_PER_AA()
	{
		return m_iAI_CONFIG_MILITARY_MELEE_PER_AA;
	}
	inline int getAI_CONFIG_MILITARY_AIRCRAFT_PER_CARRIER_SPACE()
	{
		return m_iAI_CONFIG_MILITARY_AIRCRAFT_PER_CARRIER_SPACE;
	}
	inline int getAI_CONFIG_MILITARY_TILES_PER_SHIP()
	{
		return m_iAI_CONFIG_MILITARY_TILES_PER_SHIP;
	}
#endif
...
#if defined(MOD_CONFIG_AI_IN_XML)
	inline int getWARMONGER_THREAT_MINOR_CITY_WEIGHT()
	{
		return m_iWARMONGER_THREAT_MINOR_CITY_WEIGHT;
	}
#endif
...
#if defined(MOD_CONFIG_AI_IN_XML)
	inline int getWARMONGER_THREAT_MAJOR_CITY_WEIGHT()
	{
		return m_iWARMONGER_THREAT_MAJOR_CITY_WEIGHT;
	}
#endif
	...
	inline int getMINOR_CIV_FIRST_CONTACT_BONUS_FRIENDSHIP()
	{
		return m_iMINOR_CIV_FIRST_CONTACT_BONUS_FRIENDSHIP;
	}
	inline int getMINOR_CIV_FIRST_CONTACT_BONUS_CULTURE()
	{
		return m_iMINOR_CIV_FIRST_CONTACT_BONUS_CULTURE;
	}
	inline int getMINOR_CIV_FIRST_CONTACT_BONUS_FAITH()
	{
		return m_iMINOR_CIV_FIRST_CONTACT_BONUS_FAITH;
	}
	inline int getMINOR_CIV_FIRST_CONTACT_BONUS_GOLD()
	{
		return m_iMINOR_CIV_FIRST_CONTACT_BONUS_GOLD;
	}
	inline int getMINOR_CIV_FIRST_CONTACT_BONUS_FOOD()
	{
		return m_iMINOR_CIV_FIRST_CONTACT_BONUS_FOOD;
	}
	inline int getMINOR_CIV_FIRST_CONTACT_BONUS_UNIT()
	{
		return m_iMINOR_CIV_FIRST_CONTACT_BONUS_UNIT;
	}
	inline int getMINOR_CIV_FIRST_CONTACT_XP_PER_ERA()
	{
		return m_iMINOR_CIV_FIRST_CONTACT_XP_PER_ERA;
	}
	inline int getMINOR_CIV_FIRST_CONTACT_XP_RANDOM()
	{
		return m_iMINOR_CIV_FIRST_CONTACT_XP_RANDOM;
	}
	inline int getMINOR_CIV_FIRST_CONTACT_PLAYER_MULTIPLIER()
	{
		return m_iMINOR_CIV_FIRST_CONTACT_PLAYER_MULTIPLIER;
	}
	inline int getMINOR_CIV_FIRST_CONTACT_PLAYER_DIVISOR()
	{
		return m_iMINOR_CIV_FIRST_CONTACT_PLAYER_DIVISOR;
	}
	inline int getMINOR_CIV_FIRST_CONTACT_SUBSEQUENT_TEAM_MULTIPLIER()
	{
		return m_iMINOR_CIV_FIRST_CONTACT_SUBSEQUENT_TEAM_MULTIPLIER;
	}
	inline int getMINOR_CIV_FIRST_CONTACT_SUBSEQUENT_TEAM_DIVISOR()
	{
		return m_iMINOR_CIV_FIRST_CONTACT_SUBSEQUENT_TEAM_DIVISOR;
	}
	inline int getMINOR_CIV_FIRST_CONTACT_FRIENDLY_BONUS_MULTIPLIER()
	{
		return m_iMINOR_CIV_FIRST_CONTACT_FRIENDLY_BONUS_MULTIPLIER;
	}
	inline int getMINOR_CIV_FIRST_CONTACT_FRIENDLY_BONUS_DIVISOR()
	{
		return m_iMINOR_CIV_FIRST_CONTACT_FRIENDLY_BONUS_DIVISOR;
	}
	inline int getMINOR_CIV_FIRST_CONTACT_FRIENDLY_UNIT_MULTIPLIER()
	{
		return m_iMINOR_CIV_FIRST_CONTACT_FRIENDLY_UNIT_MULTIPLIER;
	}
	inline int getMINOR_CIV_FIRST_CONTACT_FRIENDLY_UNIT_DIVISOR()
	{
		return m_iMINOR_CIV_FIRST_CONTACT_FRIENDLY_UNIT_DIVISOR;
	}
	inline int getMINOR_CIV_FIRST_CONTACT_HOSTILE_BONUS_MULTIPLIER()
	{
		return m_iMINOR_CIV_FIRST_CONTACT_HOSTILE_BONUS_MULTIPLIER;
	}
	inline int getMINOR_CIV_FIRST_CONTACT_HOSTILE_BONUS_DIVISOR()
	{
		return m_iMINOR_CIV_FIRST_CONTACT_HOSTILE_BONUS_DIVISOR;
	}
	inline int getMINOR_CIV_FIRST_CONTACT_HOSTILE_UNIT_MULTIPLIER()
	{
		return m_iMINOR_CIV_FIRST_CONTACT_HOSTILE_UNIT_MULTIPLIER;
	}
	inline int getMINOR_CIV_FIRST_CONTACT_HOSTILE_UNIT_DIVISOR()
	{
		return m_iMINOR_CIV_FIRST_CONTACT_HOSTILE_UNIT_DIVISOR;
	}
#endif
	...
	inline int getCITY_UNIT_LIMIT()
	{
		return m_iCITY_UNIT_LIMIT;
	}
#endif
	...
	inline int getMAX_CITY_ATTACK_RANGE()
	{
		return m_iMAX_CITY_ATTACK_RANGE;
	}
#endif
	...
	inline int getPLOT_INFLUENCE_COST_VISIBLE_DIVISOR()
	{
		return m_iPLOT_INFLUENCE_COST_VISIBLE_DIVISOR;
	}
#endif
	...
	inline int getPROMOTION_DEEPWATER_EMBARKATION()
	{
		return m_iPROMOTION_DEEPWATER_EMBARKATION;
	}
	inline int getPROMOTION_DEFENSIVE_DEEPWATER_EMBARKATION()
	{
		return m_iPROMOTION_DEFENSIVE_DEEPWATER_EMBARKATION;
	}
#endif
...
#if defined(MOD_CONFIG_AI_IN_XML)
	int m_iAI_CONFIG_MILITARY_MELEE_PER_AA;
	int m_iAI_CONFIG_MILITARY_AIRCRAFT_PER_CARRIER_SPACE;
	int m_iAI_CONFIG_MILITARY_TILES_PER_SHIP;
#endif
...
#if defined(MOD_GLOBAL_CS_GIFTS)
	int m_iMINOR_CIV_FIRST_CONTACT_BONUS_FRIENDSHIP;
	int m_iMINOR_CIV_FIRST_CONTACT_BONUS_CULTURE;
	int m_iMINOR_CIV_FIRST_CONTACT_BONUS_FAITH;
	int m_iMINOR_CIV_FIRST_CONTACT_BONUS_GOLD;
	int m_iMINOR_CIV_FIRST_CONTACT_BONUS_FOOD;
	int m_iMINOR_CIV_FIRST_CONTACT_BONUS_UNIT;
	int m_iMINOR_CIV_FIRST_CONTACT_XP_PER_ERA;
	int m_iMINOR_CIV_FIRST_CONTACT_XP_RANDOM;
	int m_iMINOR_CIV_FIRST_CONTACT_PLAYER_MULTIPLIER;
	int m_iMINOR_CIV_FIRST_CONTACT_PLAYER_DIVISOR;
	int m_iMINOR_CIV_FIRST_CONTACT_SUBSEQUENT_TEAM_MULTIPLIER;
	int m_iMINOR_CIV_FIRST_CONTACT_SUBSEQUENT_TEAM_DIVISOR;
	int m_iMINOR_CIV_FIRST_CONTACT_FRIENDLY_BONUS_MULTIPLIER;
	int m_iMINOR_CIV_FIRST_CONTACT_FRIENDLY_BONUS_DIVISOR;
	int m_iMINOR_CIV_FIRST_CONTACT_FRIENDLY_UNIT_MULTIPLIER;
	int m_iMINOR_CIV_FIRST_CONTACT_FRIENDLY_UNIT_DIVISOR;
	int m_iMINOR_CIV_FIRST_CONTACT_HOSTILE_BONUS_MULTIPLIER;
	int m_iMINOR_CIV_FIRST_CONTACT_HOSTILE_BONUS_DIVISOR;
	int m_iMINOR_CIV_FIRST_CONTACT_HOSTILE_UNIT_MULTIPLIER;
	int m_iMINOR_CIV_FIRST_CONTACT_HOSTILE_UNIT_DIVISOR;
#endif
...
#if defined(MOD_UI_CITY_EXPANSION)
	int m_iPLOT_INFLUENCE_COST_VISIBLE_DIVISOR;
#endif
...
#if defined(MOD_PROMOTIONS_DEEP_WATER_EMBARKATION)
	int m_iPROMOTION_DEEPWATER_EMBARKATION;
	int m_iPROMOTION_DEFENSIVE_DEEPWATER_EMBARKATION;
#endif
