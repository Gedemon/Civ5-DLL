...
int CustomMods::getOption(string sOption, int defValue) {
	if (!m_bInit) {
		...
		MOD_OPT_CACHE(TRAITS_PANTHEON_IS_RELIGION);
		...
		MOD_OPT_CACHE(AI_SMART_TILE_IMPROVERS);
		MOD_OPT_CACHE(AI_SMART_UPGRADES);
		MOD_OPT_CACHE(AI_SMART_PROMOTIONS);
		MOD_OPT_CACHE(AI_SMART_HEALING);
		MOD_OPT_CACHE(AI_SMART_GOLD_PURCHASE);
		MOD_OPT_CACHE(AI_SMART_FLEE_FROM_DANGER);
		MOD_OPT_CACHE(AI_SMART_RANGED_UNITS);
		MOD_OPT_CACHE(AI_SMART_AIR_SWEEPS);
		MOD_OPT_CACHE(AI_SMART_INTERCEPTIONS);
		MOD_OPT_CACHE(AI_SMART_CARRIERS);
		MOD_OPT_CACHE(AI_SMART_TACTICS);
