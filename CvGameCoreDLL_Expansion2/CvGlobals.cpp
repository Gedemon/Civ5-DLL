...
#if defined(MOD_CONFIG_AI_IN_XML)
	m_iWARMONGER_THREAT_MINOR_CITY_WEIGHT = getDefineINT("WARMONGER_THREAT_MINOR_CITY_WEIGHT");
#endif
...
#if defined(MOD_CONFIG_AI_IN_XML)
	m_iWARMONGER_THREAT_MAJOR_CITY_WEIGHT = getDefineINT("WARMONGER_THREAT_MAJOR_CITY_WEIGHT");
#endif
...
#if defined(MOD_EVENTS_CITY_BOMBARD)
	m_iMAX_CITY_ATTACK_RANGE = getDefineINT("MAX_CITY_ATTACK_RANGE");
#endif
