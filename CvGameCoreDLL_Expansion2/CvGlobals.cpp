...
// -- floats --
	...
	m_iCULTURE_DIFFUSION_ENABLED(0),
	m_iCULTURE_CITY_CAPED_FACTOR(0),
	m_iCULTURE_DECAY_RATE(0),
	m_iCULTURE_ALLOW_TILE_ACQUISITION(0),
	m_iCULTURE_ALLOW_TILE_FLIPPING(0),
	m_iCULTURE_USE_POLICIES(0),
	m_iCULTURE_MAX_LINES_UI(0),
	m_iCULTURE_CITY_BASE_PRODUCTION(0),
	m_iCULTURE_CITY_FACTOR(0),
	m_iCULTURE_CITY_RATIO(0),
	m_iCULTURE_OUTPUT_USE_LOG(0),
	m_iCULTURE_CITY_CONVERSION_RATE(0),
	m_iCULTURE_LOST_CITY_CONQUEST(0),
	m_iCULTURE_GAIN_CITY_CONQUEST(0),
	m_iCULTURE_LOST_PLOT_CONQUEST(0),
	m_iCULTURE_GAIN_PLOT_CONQUEST(0),
	m_iCULTURE_MINIMUM_FOR_ACQUISITION(0),
	m_iCULTURE_FLIPPING_RATIO(0),
	m_iCULTURE_FLIPPING_MAX_DISTANCE(0),
	m_iCULTURE_FLIPPING_ONLY_ADJACENT(0),
	m_iCULTURE_NO_FORTIFICATION_FLIPPING(0),
	m_iCULTURE_MINIMAL_ON_OWNED_PLOT(0),
	m_iCULTURE_DIFFUSION_THRESHOLD(0),
	m_iCULTURE_CROSS_MOUNTAIN_THRESHOLD(0),
	m_iCULTURE_CROSS_MARSH_THRESHOLD(0),
	m_iCULTURE_CROSS_JUNGLE_THRESHOLD(0),
	m_iCULTURE_CROSS_SNOW_THRESHOLD(0),
	m_iCULTURE_CROSS_DESERT_THRESHOLD(0),
	m_iCULTURE_CROSS_TUNDRA_THRESHOLD(0),
	m_iCULTURE_CROSS_RIVER_THRESHOLD(0),
	m_iCULTURE_CROSS_HILLS_THRESHOLD(0),
	m_iCULTURE_CROSS_FOREST_THRESHOLD(0),
	m_iCULTURE_DIFFUSION_RATE(0),
	m_iCULTURE_ABSOLUTE_MAX_PERCENT(0),
	m_iCULTURE_NORMAL_MAX_PERCENT(0),
	m_iCULTURE_FOLLOW_RIVER_MAX(0),
	m_iCULTURE_FOLLOW_ROAD_MAX(0),
	m_iCULTURE_CROSS_FOREST_MAX(0),
	m_iCULTURE_CROSS_HILLS_MAX(0),
	m_iCULTURE_CROSS_TUNDRA_MAX(0),
	m_iCULTURE_CROSS_RIVER_MAX(0),
	m_iCULTURE_CROSS_DESERT_MAX(0),
	m_iCULTURE_CROSS_SNOW_MAX(0),
	m_iCULTURE_CROSS_JUNGLE_MAX(0),
	m_iCULTURE_CROSS_MARSH_MAX(0),
	m_iCULTURE_CROSS_MOUNTAIN_MAX(0),
	m_iCULTURE_CROSS_FOREST_PENALTY(0),
	m_iCULTURE_CROSS_HILLS_PENALTY(0),
	m_iCULTURE_CROSS_TUNDRA_PENALTY(0),
	m_iCULTURE_CROSS_RIVER_PENALTY(0),
	m_iCULTURE_CROSS_DESERT_PENALTY(0),
	m_iCULTURE_CROSS_SNOW_PENALTY(0),
	m_iCULTURE_CROSS_JUNGLE_PENALTY(0),
	m_iCULTURE_CROSS_MARSH_PENALTY(0),
	m_iCULTURE_CROSS_MOUNTAIN_PENALTY(0),
	m_iCULTURE_FOLLOW_RIVER_BONUS(0),
	m_iCULTURE_FOLLOW_ROAD_BONUS(0),
	m_iCULTURE_CONQUEST_ENABLED(0),
	m_iCULTURE_MINIMAL_FOR_CONQUEST(0),
	m_iCULTURE_CONQUEST_EVEN_LOWER(0),
	m_iCULTURE_CONQUEST_EVEN_NONE(0),
	m_iCULTURE_LOCKED_TURN_ON_CONQUEST(0),
	m_iCULTURE_CONQUEST_ONLY_ADJACENT(0),
	m_iCULTURE_LOCK_FLIPPING_ON_WAR(0),
	m_iCULTURE_TRADITION_OPENER_CONVERSION_RATE(0),
	m_iCULTURE_TRADITION_FINISHER_CONVERSION_RATE(0),
	m_iCULTURE_SOCIALIST_REALISM_CONVERSION_RATE(0),
	m_iCULTURE_MEDIA_CULTURE_CONVERSION_RATE(0),
	m_iCULTURE_NATIONALISM_CONVERSION_RATE(0),
	m_iCULTURE_LIBRARY_CONVERSION_RATE(0),
	m_iCULTURE_UNIVERSITY_CONVERSION_RATE(0),
	m_iCULTURE_PUBLIC_SCHOOL_CONVERSION_RATE(0),
	m_iCULTURE_IMPROVEMENT_CONVERSION_RATE(0),
	m_iCULTURE_UNIT_CONVERSION_RATE(0),
	
	GD_INT_INIT(CULTURE_DIFFUSION_VARIATION_BY_ERA)
	GD_INT_INIT(CULTURE_LIBERATE_PLOT_ENABLED)
	GD_INT_INIT(CULTURE_LIBERATE_PLOT_CS_BONUS)
	// RED >>>>>
...
void CvGlobals::cacheGlobals()
{
	...
	m_iCULTURE_DIFFUSION_ENABLED = getDefineINT("CULTURE_DIFFUSION_ENABLED");
	m_iCULTURE_CITY_CAPED_FACTOR = getDefineINT("CULTURE_CITY_CAPED_FACTOR");
	m_iCULTURE_DECAY_RATE = getDefineINT("CULTURE_DECAY_RATE");
	m_iCULTURE_ALLOW_TILE_ACQUISITION = getDefineINT("CULTURE_ALLOW_TILE_ACQUISITION");
	m_iCULTURE_ALLOW_TILE_FLIPPING = getDefineINT("CULTURE_ALLOW_TILE_FLIPPING");
	m_iCULTURE_USE_POLICIES = getDefineINT("CULTURE_USE_POLICIES");
	m_iCULTURE_MAX_LINES_UI = getDefineINT("CULTURE_MAX_LINES_UI");
	m_iCULTURE_CITY_BASE_PRODUCTION = getDefineINT("CULTURE_CITY_BASE_PRODUCTION");
	m_iCULTURE_CITY_FACTOR = getDefineINT("CULTURE_CITY_FACTOR");
	m_iCULTURE_CITY_RATIO = getDefineINT("CULTURE_CITY_RATIO");
	m_iCULTURE_OUTPUT_USE_LOG = getDefineINT("CULTURE_OUTPUT_USE_LOG");
	m_iCULTURE_CITY_CONVERSION_RATE = getDefineINT("CULTURE_CITY_CONVERSION_RATE");
	m_iCULTURE_LOST_CITY_CONQUEST = getDefineINT("CULTURE_LOST_CITY_CONQUEST");
	m_iCULTURE_GAIN_CITY_CONQUEST = getDefineINT("CULTURE_GAIN_CITY_CONQUEST");
	m_iCULTURE_LOST_PLOT_CONQUEST = getDefineINT("CULTURE_LOST_PLOT_CONQUEST");
	m_iCULTURE_GAIN_PLOT_CONQUEST = getDefineINT("CULTURE_GAIN_PLOT_CONQUEST");
	m_iCULTURE_MINIMUM_FOR_ACQUISITION = getDefineINT("CULTURE_MINIMUM_FOR_ACQUISITION");
	m_iCULTURE_FLIPPING_RATIO = getDefineINT("CULTURE_FLIPPING_RATIO");
	m_iCULTURE_FLIPPING_MAX_DISTANCE = getDefineINT("CULTURE_FLIPPING_MAX_DISTANCE");
	m_iCULTURE_FLIPPING_ONLY_ADJACENT = getDefineINT("CULTURE_FLIPPING_ONLY_ADJACENT");
	m_iCULTURE_NO_FORTIFICATION_FLIPPING = getDefineINT("CULTURE_NO_FORTIFICATION_FLIPPING");
	m_iCULTURE_MINIMAL_ON_OWNED_PLOT = getDefineINT("CULTURE_MINIMAL_ON_OWNED_PLOT");
	m_iCULTURE_DIFFUSION_THRESHOLD = getDefineINT("CULTURE_DIFFUSION_THRESHOLD");
	m_iCULTURE_CROSS_MOUNTAIN_THRESHOLD = getDefineINT("CULTURE_CROSS_MOUNTAIN_THRESHOLD");
	m_iCULTURE_CROSS_MARSH_THRESHOLD = getDefineINT("CULTURE_CROSS_MARSH_THRESHOLD");
	m_iCULTURE_CROSS_JUNGLE_THRESHOLD = getDefineINT("CULTURE_CROSS_JUNGLE_THRESHOLD");
	m_iCULTURE_CROSS_SNOW_THRESHOLD = getDefineINT("CULTURE_CROSS_SNOW_THRESHOLD");
	m_iCULTURE_CROSS_DESERT_THRESHOLD = getDefineINT("CULTURE_CROSS_DESERT_THRESHOLD");
	m_iCULTURE_CROSS_TUNDRA_THRESHOLD = getDefineINT("CULTURE_CROSS_TUNDRA_THRESHOLD");
	m_iCULTURE_CROSS_RIVER_THRESHOLD = getDefineINT("CULTURE_CROSS_RIVER_THRESHOLD");
	m_iCULTURE_CROSS_HILLS_THRESHOLD = getDefineINT("CULTURE_CROSS_HILLS_THRESHOLD");
	m_iCULTURE_CROSS_FOREST_THRESHOLD = getDefineINT("CULTURE_CROSS_FOREST_THRESHOLD");
	m_iCULTURE_DIFFUSION_RATE = getDefineINT("CULTURE_DIFFUSION_RATE");
	m_iCULTURE_ABSOLUTE_MAX_PERCENT = getDefineINT("CULTURE_ABSOLUTE_MAX_PERCENT");
	m_iCULTURE_NORMAL_MAX_PERCENT = getDefineINT("CULTURE_NORMAL_MAX_PERCENT");
	m_iCULTURE_FOLLOW_RIVER_MAX = getDefineINT("CULTURE_FOLLOW_RIVER_MAX");
	m_iCULTURE_FOLLOW_ROAD_MAX = getDefineINT("CULTURE_FOLLOW_ROAD_MAX");
	m_iCULTURE_CROSS_FOREST_MAX = getDefineINT("CULTURE_CROSS_FOREST_MAX");
	m_iCULTURE_CROSS_HILLS_MAX = getDefineINT("CULTURE_CROSS_HILLS_MAX");
	m_iCULTURE_CROSS_TUNDRA_MAX = getDefineINT("CULTURE_CROSS_TUNDRA_MAX");
	m_iCULTURE_CROSS_RIVER_MAX = getDefineINT("CULTURE_CROSS_RIVER_MAX");
	m_iCULTURE_CROSS_DESERT_MAX = getDefineINT("CULTURE_CROSS_DESERT_MAX");
	m_iCULTURE_CROSS_SNOW_MAX = getDefineINT("CULTURE_CROSS_SNOW_MAX");
	m_iCULTURE_CROSS_JUNGLE_MAX = getDefineINT("CULTURE_CROSS_JUNGLE_MAX");
	m_iCULTURE_CROSS_MARSH_MAX = getDefineINT("CULTURE_CROSS_MARSH_MAX");
	m_iCULTURE_CROSS_MOUNTAIN_MAX = getDefineINT("CULTURE_CROSS_MOUNTAIN_MAX");
	m_iCULTURE_CROSS_FOREST_PENALTY = getDefineINT("CULTURE_CROSS_FOREST_PENALTY");
	m_iCULTURE_CROSS_HILLS_PENALTY = getDefineINT("CULTURE_CROSS_HILLS_PENALTY");
	m_iCULTURE_CROSS_TUNDRA_PENALTY = getDefineINT("CULTURE_CROSS_TUNDRA_PENALTY");
	m_iCULTURE_CROSS_RIVER_PENALTY = getDefineINT("CULTURE_CROSS_RIVER_PENALTY");
	m_iCULTURE_CROSS_DESERT_PENALTY = getDefineINT("CULTURE_CROSS_DESERT_PENALTY");
	m_iCULTURE_CROSS_SNOW_PENALTY = getDefineINT("CULTURE_CROSS_SNOW_PENALTY");
	m_iCULTURE_CROSS_JUNGLE_PENALTY = getDefineINT("CULTURE_CROSS_JUNGLE_PENALTY");
	m_iCULTURE_CROSS_MARSH_PENALTY = getDefineINT("CULTURE_CROSS_MARSH_PENALTY");
	m_iCULTURE_CROSS_MOUNTAIN_PENALTY = getDefineINT("CULTURE_CROSS_MOUNTAIN_PENALTY");
	m_iCULTURE_FOLLOW_RIVER_BONUS = getDefineINT("CULTURE_FOLLOW_RIVER_BONUS");
	m_iCULTURE_FOLLOW_ROAD_BONUS = getDefineINT("CULTURE_FOLLOW_ROAD_BONUS");
	m_iCULTURE_CONQUEST_ENABLED = getDefineINT("CULTURE_CONQUEST_ENABLED");
	m_iCULTURE_MINIMAL_FOR_CONQUEST = getDefineINT("CULTURE_MINIMAL_FOR_CONQUEST");
	m_iCULTURE_CONQUEST_EVEN_LOWER = getDefineINT("CULTURE_CONQUEST_EVEN_LOWER");
	m_iCULTURE_CONQUEST_EVEN_NONE = getDefineINT("CULTURE_CONQUEST_EVEN_NONE");
	m_iCULTURE_LOCKED_TURN_ON_CONQUEST = getDefineINT("CULTURE_LOCKED_TURN_ON_CONQUEST");
	m_iCULTURE_CONQUEST_ONLY_ADJACENT = getDefineINT("CULTURE_CONQUEST_ONLY_ADJACENT");
	m_iCULTURE_LOCK_FLIPPING_ON_WAR = getDefineINT("CULTURE_LOCK_FLIPPING_ON_WAR");
	m_iCULTURE_TRADITION_OPENER_CONVERSION_RATE = getDefineINT("CULTURE_TRADITION_OPENER_CONVERSION_RATE");
	m_iCULTURE_TRADITION_FINISHER_CONVERSION_RATE = getDefineINT("CULTURE_TRADITION_FINISHER_CONVERSION_RATE");
	m_iCULTURE_SOCIALIST_REALISM_CONVERSION_RATE = getDefineINT("CULTURE_SOCIALIST_REALISM_CONVERSION_RATE");
	m_iCULTURE_MEDIA_CULTURE_CONVERSION_RATE = getDefineINT("CULTURE_MEDIA_CULTURE_CONVERSION_RATE");
	m_iCULTURE_NATIONALISM_CONVERSION_RATE = getDefineINT("CULTURE_NATIONALISM_CONVERSION_RATE");
	m_iCULTURE_LIBRARY_CONVERSION_RATE = getDefineINT("CULTURE_LIBRARY_CONVERSION_RATE");
	m_iCULTURE_UNIVERSITY_CONVERSION_RATE = getDefineINT("CULTURE_UNIVERSITY_CONVERSION_RATE");
	m_iCULTURE_PUBLIC_SCHOOL_CONVERSION_RATE = getDefineINT("CULTURE_PUBLIC_SCHOOL_CONVERSION_RATE");
	m_iCULTURE_IMPROVEMENT_CONVERSION_RATE = getDefineINT("CULTURE_IMPROVEMENT_CONVERSION_RATE");
	m_iCULTURE_UNIT_CONVERSION_RATE = getDefineINT("CULTURE_UNIT_CONVERSION_RATE");

	GD_INT_CACHE(CULTURE_DIFFUSION_VARIATION_BY_ERA)
	GD_INT_CACHE(CULTURE_LIBERATE_PLOT_ENABLED)
	GD_INT_CACHE(CULTURE_LIBERATE_PLOT_CS_BONUS)
