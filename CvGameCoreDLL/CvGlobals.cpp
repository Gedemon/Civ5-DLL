...
// RED <<<<<
GD_INT_INIT(CITY_LAND_UNIT_LIMIT)
GD_INT_INIT(CITY_SEA_UNIT_LIMIT)
GD_INT_INIT(CITY_AIR_UNIT_LIMIT)
GD_INT_INIT(LIBERATE_PLOT_CS_BONUS)
GD_INT_INIT(FIRE_POINTS_OFFENSIVE_STRIKE_COST)
GD_INT_INIT(FIRE_POINTS_DEFENSIVE_STRIKE_COST)
GD_INT_INIT(FIRE_POINTS_COUNTER_FIRE_COST)
GD_INT_INIT(FIRE_POINTS_OPPORTUNITY_FIRE_COST)
GD_INT_INIT(SUPPORT_FIRE_MAX_REQUEST_RANGE)
GD_INT_INIT(SUPPORT_FIRE_MIN_HEALTH_PERCENT_LEFT)
...
GD_INT_INIT(EXPERIENCE_INTERCEPTING_UNIT_AIR)
GD_INT_INIT(FORCE_UNIT_SPAWNING_ON_OCCUPIED_PLOT)
GD_INT_INIT(NO_AUTO_NAMING)
GD_INT_INIT(RETREAT_RATIO)
GD_INT_INIT(NO_DIPLO_STATEMENT)
GD_INT_INIT(INITIAL_MATERIEL_VALUE)
GD_INT_INIT(INITIAL_PERSONNEL_VALUE)
GD_INT_INIT(INITIAL_OIL_VALUE)
GD_INT_INIT(REINFORCEMENT_RATIO)
GD_INT_INIT(REINFORCEMENT_BASE)
GD_INT_INIT(MAX_HP_HEALED)
GD_INT_INIT(RESISTANCE_REINFORCEMENT_PERCENT)
GD_INT_INIT(OCCUPIED_REINFORCEMENT_PERCENT)
GD_INT_INIT(CAPTURED_REINFORCEMENT_PERCENT)
GD_INT_INIT(FRIEND_REINFORCEMENT_PERCENT)
GD_INT_INIT(ALLY_REINFORCEMENT_PERCENT)
GD_INT_INIT(WOUNDED_PERCENT)
GD_INT_INIT(HOSPITAL_HEALING_PERCENT)
GD_INT_INIT(HOSPITAL_MAX_HEALING_PER_TURN)
GD_INT_INIT(RADIO_RECRUITING_FACTOR)
GD_INT_INIT(RADIO_PROPAGANDA_BONUS)
GD_INT_INIT(WAR_BONDS_PRODUCTION_PERCENT)
GD_INT_INIT(RESOURCE_PRODUCTION_FACTOR)
GD_INT_INIT(RESOURCE_OIL_LIGHT_RATIONING)
GD_INT_INIT(RESOURCE_OIL_RATIONING)
GD_INT_INIT(RESOURCE_OIL_HEAVY_RATIONING)
GD_INT_INIT(RESOURCE_CONSUMPTION)
GD_INT_INIT(RESOURCE_CONNECTION)
GD_INT_INIT(RESOURCE_FROM_FRIENDS)
GD_INT_INIT(UNIT_BLEEDING)
GD_INT_INIT(BLEEDING_PER_TURN)
GD_INT_INIT(TRANSPORT_DEFAULT)
GD_INT_INIT(TRANSPORT_DEFAULT_REFERENCE)
GD_INT_INIT(WAR_MINIMUM_STARTING_TURN)
GD_INT_INIT(PERMANENT_WAR_DECLARATION)
GD_INT_INIT(CAN_BUILD_UNIT_IN_OCCUPIED_CITY )
GD_INT_INIT(REVEAL_ALL_CITIES)
GD_INT_INIT(REVEAL_ALL_MAP)
GD_INT_INIT(EMBARK_FROM_HARBOR)
GD_INT_INIT(ALLOW_SCRIPTED_EVENTS)
GD_INT_INIT(ALLOW_ALTERNATE_HISTORY)
GD_INT_INIT(SCENARIO_MATERIEL_PER_TURN)
GD_INT_INIT(SCENARIO_PERSONNEL_PER_TURN )
GD_INT_INIT(SCENARIO_OIL_PER_TURN)
GD_INT_INIT(SCENARIO_MAX_MATERIEL_BONUS)
GD_INT_INIT(SCENARIO_MAX_OIL_BONUS)
GD_INT_INIT(SCENARIO_MAX_PERSONNEL_BONUS)
GD_INT_INIT(CLOSE_MINOR_NEUTRAL_CIV_BORDERS )
GD_INT_INIT(CHECK_FOR_ORPHAN_TILE)
GD_INT_INIT(UNIT_MAX_PLOT_CONTROL_RANGE)
GD_INT_INIT(CITY_MAX_PLOT_CONTROL_RANGE)
GD_INT_INIT(NUM_BUILDINGS_IMPORTANT_CITY )
GD_INT_INIT(USE_TACTICAL_RANGE)
GD_INT_INIT(USE_FAST_OCEAN_MOVE )
GD_INT_INIT(USE_FAST_NAVAL_MOVE )
GD_INT_INIT(MIN_HP_LEFT_BEFORE_ESCAPING_CITY)
GD_INT_INIT(MAX_PERCENT_HP_LOSS_ESCAPE)
GD_INT_INIT(MIN_PERCENT_HP_LOSS_ESCAPE)
GD_INT_INIT(MAX_CITY_BOMBARD_DAMAGE_PERCENT)
GD_INT_INIT(ALLOW_CITY_IMPROVEMENT_DAMAGE)
GD_INT_INIT(IMPROVEMENT_REPAIR_PER_TURN)
GD_INT_INIT(IMPROVEMENT_DAMAGED_THRESHOLD)
GD_INT_INIT(IMPROVEMENT_MAX_DAMAGE)
GD_INT_INIT(NO_SUPPLY_LINE_INITIAL_MOVEMENT_LEFT)
GD_INT_INIT(NO_SUPPLY_LINE_MOVEMENT_LEFT)
GD_INT_INIT(LIGHT_RATIONING_MOVEMENT_LEFT)
GD_INT_INIT(MEDIUM_RATIONING_MOVEMENT_LEFT)
GD_INT_INIT(HEAVY_RATIONING_MOVEMENT_LEFT)
GD_INT_INIT(LIGHT_RATIONING_FUEL_CONSUMPTION)
GD_INT_INIT(MEDIUM_RATIONING_FUEL_CONSUMPTION)
GD_INT_INIT(HEAVY_RATIONING_FUEL_CONSUMPTION)
GD_INT_INIT(ALLOW_CITY_UNIT_DAMAGE)
GD_INT_INIT(MAX_UNIT_IN_CITY_BOMBARD_DAMAGE)
GD_INT_INIT(BEACHHEAD_DAMAGE)
GD_INT_INIT(AIRCRAFT_CAP)
GD_INT_INIT(LAND_CAP_RATIO)
GD_INT_INIT(RED_AI_HANDICAP)
GD_INT_INIT(AI_FREE_UNIT_SUPPLY )
GD_INT_INIT(ALLOW_AI_CONTROL )
GD_INT_INIT(USE_UNIT_RATIO_FOR_AI)
GD_INT_INIT(ALLOW_AI_UNITS_LIMIT)
GD_INT_INIT(MAX_AI_UNITS)
GD_INT_INIT(UNIT_SUPPORT_LIMIT_FOR_AI)
GD_INT_INIT(AI_UNIT_SUPPLY_THRESHOLD)
GD_INT_INIT(AI_MINIMAL_RESERVE)
GD_INT_INIT(AI_LAND_MINIMAL_RESERVE)
GD_INT_INIT(AI_AIR_MINIMAL_RESERVE)
GD_INT_INIT(AI_SEA_MINIMAL_RESERVE)
GD_INT_INIT(AI_USE_RESOURCE_LIMIT)
GD_INT_INIT(AI_TURNS_BEFORE_SHORTAGE)
GD_INT_INIT(AI_UNIT_RESOURCE_LOW)
GD_INT_INIT(AI_UNIT_RESOURCE_SHORTAGE)
GD_INT_INIT(TRACK_COMBATS_MAX_TURNS)
GD_INT_INIT(DESTROYER_SUB_HUNTING_MAX_TURNS_ATTACK)
GD_INT_INIT(DESTROYER_SUB_HUNTING_MAX_TURNS_TO_TARGET)
GD_INT_INIT(CRUISER_SUB_HUNTING_MAX_TURNS_ATTACK)
GD_INT_INIT(CRUISER_SUB_HUNTING_MAX_TURNS_TO_TARGET)
GD_INT_INIT(INTERCEPTOR_MAX_TURNS_ATTACK)
GD_INT_INIT(AIRSWEEP_MAX_TURNS_ATTACK)
GD_INT_INIT(INTERCEPTOR_RATIO_NEEDED)
GD_INT_INIT(AIRSWEEP_RATIO_NEEDED)
GD_INT_INIT(MIN_HP_LEFT_REBASE_CITY )
GD_INT_INIT(NO_SUICIDE_ATTACK)
GD_INT_INIT(SUICIDE_DAMAGE_THRESHOLD)
GD_INT_INIT(SUICIDE_DIFF_DAMAGE_THRESHOLD)
GD_INT_INIT(SUICIDE_HP_RATIO)
GD_INT_INIT(NO_AI_EMBARKATION)
GD_INT_INIT(NO_LAND_UNIT_BUILD_ON_ISLAND)
GD_INT_INIT(NO_LAND_UNIT_ISLAND_MAX_AREA)
GD_INT_INIT(MIN_HEALTH_PERCENT)
GD_INT_INIT(OPTIMAL_HEALTH_PERCENT)
GD_INT_INIT(MIN_AIR_HEALTH_PERCENT)
GD_INT_INIT(OPTIMAL_AIR_HEALTH_PERCENT)
GD_INT_INIT(MIN_SEA_HEALTH_PERCENT)
GD_INT_INIT(OPTIMAL_SEA_HEALTH_PERCENT)
...
void CvGlobals::cacheGlobals()
{
	...
	m_iSUPPLY_PRODMOD_PER_UNIT = getDefineINT("SUPPLY_PRODMOD_PER_UNIT");
	...
	// RED <<<<<
	GD_INT_CACHE(CITY_LAND_UNIT_LIMIT)
	GD_INT_CACHE(CITY_SEA_UNIT_LIMIT)
	GD_INT_CACHE(CITY_AIR_UNIT_LIMIT)
	GD_INT_CACHE(LIBERATE_PLOT_CS_BONUS)
	GD_INT_CACHE(FIRE_POINTS_OFFENSIVE_STRIKE_COST)
	GD_INT_CACHE(FIRE_POINTS_DEFENSIVE_STRIKE_COST)
	GD_INT_CACHE(FIRE_POINTS_COUNTER_FIRE_COST)
	GD_INT_CACHE(FIRE_POINTS_OPPORTUNITY_FIRE_COST)
	GD_INT_CACHE(SUPPORT_FIRE_MAX_REQUEST_RANGE)
	GD_INT_CACHE(SUPPORT_FIRE_MIN_HEALTH_PERCENT_LEFT)
	...
	GD_INT_CACHE(EXPERIENCE_INTERCEPTING_UNIT_AIR)
	GD_INT_CACHE(FORCE_UNIT_SPAWNING_ON_OCCUPIED_PLOT)
	GD_INT_CACHE(NO_AUTO_NAMING)
	GD_INT_CACHE(RETREAT_RATIO)
	GD_INT_CACHE(NO_DIPLO_STATEMENT)
	GD_INT_CACHE(INITIAL_MATERIEL_VALUE)
	GD_INT_CACHE(INITIAL_PERSONNEL_VALUE)
	GD_INT_CACHE(INITIAL_OIL_VALUE)
	GD_INT_CACHE(REINFORCEMENT_RATIO)
	GD_INT_CACHE(REINFORCEMENT_BASE)
	GD_INT_CACHE(MAX_HP_HEALED)
	GD_INT_CACHE(RESISTANCE_REINFORCEMENT_PERCENT)
	GD_INT_CACHE(OCCUPIED_REINFORCEMENT_PERCENT)
	GD_INT_CACHE(CAPTURED_REINFORCEMENT_PERCENT)
	GD_INT_CACHE(FRIEND_REINFORCEMENT_PERCENT)
	GD_INT_CACHE(ALLY_REINFORCEMENT_PERCENT)
	GD_INT_CACHE(WOUNDED_PERCENT)
	GD_INT_CACHE(HOSPITAL_HEALING_PERCENT)
	GD_INT_CACHE(HOSPITAL_MAX_HEALING_PER_TURN)
	GD_INT_CACHE(RADIO_RECRUITING_FACTOR)
	GD_INT_CACHE(RADIO_PROPAGANDA_BONUS)
	GD_INT_CACHE(WAR_BONDS_PRODUCTION_PERCENT)
	GD_INT_CACHE(RESOURCE_PRODUCTION_FACTOR)
	GD_INT_CACHE(RESOURCE_OIL_LIGHT_RATIONING)
	GD_INT_CACHE(RESOURCE_OIL_RATIONING)
	GD_INT_CACHE(RESOURCE_OIL_HEAVY_RATIONING)
	GD_INT_CACHE(RESOURCE_CONSUMPTION)
	GD_INT_CACHE(RESOURCE_CONNECTION)
	GD_INT_CACHE(RESOURCE_FROM_FRIENDS)
	GD_INT_CACHE(UNIT_BLEEDING)
	GD_INT_CACHE(BLEEDING_PER_TURN)
	GD_INT_CACHE(TRANSPORT_DEFAULT)
	GD_INT_CACHE(TRANSPORT_DEFAULT_REFERENCE)
	GD_INT_CACHE(WAR_MINIMUM_STARTING_TURN)
	GD_INT_CACHE(PERMANENT_WAR_DECLARATION)
	GD_INT_CACHE(CAN_BUILD_UNIT_IN_OCCUPIED_CITY )
	GD_INT_CACHE(REVEAL_ALL_CITIES)
	GD_INT_CACHE(REVEAL_ALL_MAP)
	GD_INT_CACHE(EMBARK_FROM_HARBOR)
	GD_INT_CACHE(ALLOW_SCRIPTED_EVENTS)
	GD_INT_CACHE(ALLOW_ALTERNATE_HISTORY)
	GD_INT_CACHE(SCENARIO_MATERIEL_PER_TURN)
	GD_INT_CACHE(SCENARIO_PERSONNEL_PER_TURN )
	GD_INT_CACHE(SCENARIO_OIL_PER_TURN)
	GD_INT_CACHE(SCENARIO_MAX_MATERIEL_BONUS)
	GD_INT_CACHE(SCENARIO_MAX_OIL_BONUS)
	GD_INT_CACHE(SCENARIO_MAX_PERSONNEL_BONUS)
	GD_INT_CACHE(CLOSE_MINOR_NEUTRAL_CIV_BORDERS )
	GD_INT_CACHE(CHECK_FOR_ORPHAN_TILE)
	GD_INT_CACHE(UNIT_MAX_PLOT_CONTROL_RANGE)
	GD_INT_CACHE(CITY_MAX_PLOT_CONTROL_RANGE)
	GD_INT_CACHE(NUM_BUILDINGS_IMPORTANT_CITY )
	GD_INT_CACHE(USE_TACTICAL_RANGE)
	GD_INT_CACHE(USE_FAST_OCEAN_MOVE )
	GD_INT_CACHE(USE_FAST_NAVAL_MOVE )
	GD_INT_CACHE(MIN_HP_LEFT_BEFORE_ESCAPING_CITY)
	GD_INT_CACHE(MAX_PERCENT_HP_LOSS_ESCAPE)
	GD_INT_CACHE(MIN_PERCENT_HP_LOSS_ESCAPE)
	GD_INT_CACHE(MAX_CITY_BOMBARD_DAMAGE_PERCENT)
	GD_INT_CACHE(ALLOW_CITY_IMPROVEMENT_DAMAGE)
	GD_INT_CACHE(IMPROVEMENT_REPAIR_PER_TURN)
	GD_INT_CACHE(IMPROVEMENT_DAMAGED_THRESHOLD)
	GD_INT_CACHE(IMPROVEMENT_MAX_DAMAGE)
	GD_INT_CACHE(NO_SUPPLY_LINE_INITIAL_MOVEMENT_LEFT)
	GD_INT_CACHE(NO_SUPPLY_LINE_MOVEMENT_LEFT)
	GD_INT_CACHE(LIGHT_RATIONING_MOVEMENT_LEFT)
	GD_INT_CACHE(MEDIUM_RATIONING_MOVEMENT_LEFT)
	GD_INT_CACHE(HEAVY_RATIONING_MOVEMENT_LEFT)
	GD_INT_CACHE(LIGHT_RATIONING_FUEL_CONSUMPTION)
	GD_INT_CACHE(MEDIUM_RATIONING_FUEL_CONSUMPTION)
	GD_INT_CACHE(HEAVY_RATIONING_FUEL_CONSUMPTION)
	GD_INT_CACHE(ALLOW_CITY_UNIT_DAMAGE)
	GD_INT_CACHE(MAX_UNIT_IN_CITY_BOMBARD_DAMAGE)
	GD_INT_CACHE(BEACHHEAD_DAMAGE)
	GD_INT_CACHE(AIRCRAFT_CAP)
	GD_INT_CACHE(LAND_CAP_RATIO)
	GD_INT_CACHE(RED_AI_HANDICAP)
	GD_INT_CACHE(AI_FREE_UNIT_SUPPLY )
	GD_INT_CACHE(ALLOW_AI_CONTROL )
	GD_INT_CACHE(USE_UNIT_RATIO_FOR_AI)
	GD_INT_CACHE(ALLOW_AI_UNITS_LIMIT)
	GD_INT_CACHE(MAX_AI_UNITS)
	GD_INT_CACHE(UNIT_SUPPORT_LIMIT_FOR_AI)
	GD_INT_CACHE(AI_UNIT_SUPPLY_THRESHOLD)
	GD_INT_CACHE(AI_MINIMAL_RESERVE)
	GD_INT_CACHE(AI_LAND_MINIMAL_RESERVE)
	GD_INT_CACHE(AI_AIR_MINIMAL_RESERVE)
	GD_INT_CACHE(AI_SEA_MINIMAL_RESERVE)
	GD_INT_CACHE(AI_USE_RESOURCE_LIMIT)
	GD_INT_CACHE(AI_TURNS_BEFORE_SHORTAGE)
	GD_INT_CACHE(AI_UNIT_RESOURCE_LOW)
	GD_INT_CACHE(AI_UNIT_RESOURCE_SHORTAGE)
	GD_INT_CACHE(TRACK_COMBATS_MAX_TURNS)
	GD_INT_CACHE(DESTROYER_SUB_HUNTING_MAX_TURNS_ATTACK)
	GD_INT_CACHE(DESTROYER_SUB_HUNTING_MAX_TURNS_TO_TARGET)
	GD_INT_CACHE(CRUISER_SUB_HUNTING_MAX_TURNS_ATTACK)
	GD_INT_CACHE(CRUISER_SUB_HUNTING_MAX_TURNS_TO_TARGET)
	GD_INT_CACHE(INTERCEPTOR_MAX_TURNS_ATTACK)
	GD_INT_CACHE(AIRSWEEP_MAX_TURNS_ATTACK)
	GD_INT_CACHE(INTERCEPTOR_RATIO_NEEDED)
	GD_INT_CACHE(AIRSWEEP_RATIO_NEEDED)
	GD_INT_CACHE(MIN_HP_LEFT_REBASE_CITY )
	GD_INT_CACHE(NO_SUICIDE_ATTACK)
	GD_INT_CACHE(SUICIDE_DAMAGE_THRESHOLD)
	GD_INT_CACHE(SUICIDE_DIFF_DAMAGE_THRESHOLD)
	GD_INT_CACHE(SUICIDE_HP_RATIO)
	GD_INT_CACHE(NO_AI_EMBARKATION)
	GD_INT_CACHE(NO_LAND_UNIT_BUILD_ON_ISLAND)
	GD_INT_CACHE(NO_LAND_UNIT_ISLAND_MAX_AREA)
	GD_INT_CACHE(MIN_HEALTH_PERCENT)
	GD_INT_CACHE(OPTIMAL_HEALTH_PERCENT)
	GD_INT_CACHE(MIN_AIR_HEALTH_PERCENT)
	GD_INT_CACHE(OPTIMAL_AIR_HEALTH_PERCENT)
	GD_INT_CACHE(MIN_SEA_HEALTH_PERCENT)
	GD_INT_CACHE(OPTIMAL_SEA_HEALTH_PERCENT)
	GD_INT_CACHE(CLOSE_LAND_DISTANCE)
	GD_INT_CACHE(CLOSE_SEA_DISTANCE)
	GD_INT_CACHE(MAX_LANDING_PLOT_DISTANCE)
	// RED >>>>>
